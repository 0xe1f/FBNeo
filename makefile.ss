...
depobj += neocdlist.o \
		...
		\
		inp_pi.o aud_sdl.o support_paths.o ips_manager.o scrn.o localise_gamelist.o \
		cd_sdl2.o config.o main_pi.o run_pi.o stringset.o bzip.o drv.o media.o romdata.o \
		inpdipsw.o inputbuf.o replay.o input.o stated.o vid_ss.o
